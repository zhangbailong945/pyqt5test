...
class Ui_StatusBarWidget(object):
    def setupUi(self, StatusBarWidget):
        ...
        StatusBarWidget.setAutoFillBackground(False)
        StatusBarWidget.setStyleSheet("background-color: qlineargradient(spread:reflect, x1:0.00568182, y1:0.051, x2:0, y2:0.563, stop:0 rgba(188, 217, 235, 255), stop:1 rgba(255, 255, 255, 255));")
